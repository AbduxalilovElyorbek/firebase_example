export 'package:firebase_example/constants/colors/colors.dart';
export 'package:firebase_example/modules/ui/screens/messages/messages.dart';
export 'package:firebase_example/modules/ui/widgets/svg_icon.dart';
export 'package:flutter/material.dart';

export 'package:firebase_example/constants/icons/icons.dart';
export 'package:flutter_svg/svg.dart';

export 'package:firebase_example/modules/data/models/user.dart';
export 'package:firebase_example/modules/ui/screens/messages/widgets/chat_item.dart';

export 'package:cloud_firestore/cloud_firestore.dart';
export 'package:firebase_example/modules/ui/screens/messages/widgets/profiles_item.dart';

export 'package:firebase_auth/firebase_auth.dart';
export 'package:firebase_example/modules/ui/screens/messages/parts/chats_list.dart';
export 'package:firebase_example/modules/ui/screens/messages/parts/profiles.dart';
export 'package:firebase_example/modules/ui/screens/messages/widgets/avatar.dart';
export 'package:firebase_example/modules/ui/screens/messages/widgets/icon_widget.dart';

export 'package:firebase_example/modules/domain/usecase/login/login.dart';
export 'package:firebase_example/modules/ui/blocks/auth/auth_bloc.dart';
export 'package:firebase_example/modules/ui/screens/navigation/home.dart';
export 'package:firebase_example/modules/ui/widgets/button.dart';
export 'package:firebase_example/modules/ui/widgets/icon_button.dart';
export 'package:firebase_example/modules/ui/widgets/input.dart';
export 'package:firebase_example/modules/ui/widgets/or.dart';
export 'package:flutter_bloc/flutter_bloc.dart';

export 'dart:io';
export 'package:firebase_core/firebase_core.dart';
export 'package:firebase_example/core/untils/service/get_it.dart';
export 'package:firebase_example/modules/ui/screens/auth/onboarding/onboarding_page.dart';
export 'package:firebase_example/modules/ui/screens/auth/sign_in/sign_in_page.dart';
